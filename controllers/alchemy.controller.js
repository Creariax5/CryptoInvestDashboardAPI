// controllers/alchemy.controller.js - Alchemy API controller
...
async function getBalances(req, res) {
    try {
        ...
        // Get token balances from Alchemy service
        const balances = await alchemyService.getTokenBalances(address, networkList);
